...
#     return count
#
# def ProfileMatrix(Motif):
#     n=len(Motif)
#     profile=CountMatrix(Motif)
...
#         for j in range(k):
#             if kmer[j]=="A":
#                 kmer_prob*=Profile[0][j]
#             elif kmer[j]=="C":
#                 kmer_prob*=Profile[1][j]
#             elif kmer[j]=="G":
#                 kmer_prob*=Profile[2][j]
#             elif kmer[j]=="T":
#                 kmer_prob*=Profile[3][j]
#         if kmer_prob> prob:
#             prob=kmer_prob
#             mostProb=kmer
#     #print(mostProb)
...
#         workingMotif=[DNA[0][i:k+i]]
#         for j in range(1,t):
#             profile=ProfileMatrix(workingMotif[0:j])
#             motif=ProfileMostProbKmer(DNA[j],k,profile)
#             workingMotif.append(motif)
#         if Score(workingMotif)<Score(BestMotifs):
#             BestMotifs=workingMotif
#     PrintListFlat(BestMotifs)
#     return BestMotifs
###Subroutines needed for Greedy Motif Search
